...
class _CreateModulePageState extends State<CreateModulePage> {
  ...
  Future<void> _createModule() async {
    ...
    if (_titleErr != null || _descErr != null || _iconFile == null) {
    ...
    try {
      ...
      final iconBase64 = await _compressAndConvertBase64(_iconFile!);
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Module "${_titleC.text}" created')),
        );
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: Colors.white.withOpacity(0.25), // subtle background
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          onPressed: _loading ? null : _createModule,
