...
import '../../../Puzzel/Teacher/MatchingPuzzles/Previews/matchingPuzzlePreview.dart';
import '../../../Puzzel/Teacher/SequencePuzzles/Previews/sequencePuzzlePreview.dart';
                      ...
                      onPressed: () {
                        ...
                        switch (item.type) {
                          case TemplateType.matching_puzzle:
                            destinationPage = MatchingPuzzlePreviewPage(
                              puzzleId: item.id,
                            );
                            break;
                          case TemplateType.sequence_puzzle:
                          
 destinationPage = SequencePuzzlePreviewPage(
                              puzzleId: item.id,
                            );
                            
                            break;
                          default:
                            print('Unknown puzzle type: ${item.type}');
                            return;
                        }
